...
from simployer_client.api_response import ApiResponse, T as ApiResponseT
import simployer_client.models
from simployer_client import rest
from simployer_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(simployer_client.models, klass)
