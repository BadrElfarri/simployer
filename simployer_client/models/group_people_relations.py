...
class GroupPeopleRelations(BaseModel):
    """
    Represents the relations between people and managers in a group.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Identifier of the group.")
    people: Optional[List[StrictStr]] = Field(default=None, description="People in the group.")
    managers: Optional[List[StrictStr]] = Field(default=None, description="Managers in the group.")
    __properties: ClassVar[List[str]] = ["id", "people", "managers"]
