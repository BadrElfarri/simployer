...
class ExtendedPropertyPagination(BaseModel):
    """
    ExtendedPropertyPagination
    """ # noqa: E501
    records: Optional[List[ExtendedProperty]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "records": [ExtendedProperty.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None
        })
        return _obj
