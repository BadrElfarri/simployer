...
class OrganizationCurrencyType(str, Enum):
    """
    Specifies the currency type used by an organization.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of OrganizationCurrencyType from a JSON string"""
