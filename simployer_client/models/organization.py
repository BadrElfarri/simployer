...
class Organization(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "subType", "name", "companyNumber", "active", "departmentCode", "managerId", "parentOrganizationId", "organizationNumber", "nace", "systemCountry", "systemOrganizationCurrency"]
