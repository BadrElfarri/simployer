...
class Phone(BaseModel):
    ...
    Phone
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier of the phone")
    unit_id: Optional[StrictStr] = Field(default=None, description="Unique identifier of the unit associated with this phone", alias="unitId")
    ...
    __properties: ClassVar[List[str]] = ["id", "unitId", "unitType", "type", "number"]
