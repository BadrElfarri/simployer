...
class NextOfKin(BaseModel):
    ...
    NextOfKin
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier of the next of kin.")
    relative_id: Optional[StrictStr] = Field(default=None, description="Unique identifier of the relative associated with the next of kin.", alias="relativeId")
    name: Optional[StrictStr] = Field(default=None, description="Name of the next of kin.")
    relation: Optional[StrictStr] = Field(default=None, description="Relationship of the next of kin to the individual.")
    email: Optional[StrictStr] = Field(default=None, description="Email address of the next of kin.")
    phone_number: Optional[StrictStr] = Field(default=None, description="Phone number of the next of kin.", alias="phoneNumber")
    ...
    __properties: ClassVar[List[str]] = ["id", "relativeId", "name", "relation", "email", "phoneNumber", "country", "streetName1", "streetName2", "streetName3", "postalCode", "postalPlace"]
