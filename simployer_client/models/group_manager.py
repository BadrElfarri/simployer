...
class GroupManager(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique Identifier of the manager.")
    name: Optional[StrictStr] = Field(default=None, description="Name of the manager.")
