...
class ElectronicAddress(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier of the electronic address.")
    unit_id: Optional[StrictStr] = Field(default=None, description="Unique identifier of the unit associated with this electronic address.", alias="unitId")
    unit_type: Optional[UnitType] = Field(default=None, alias="unitType")
    type: Optional[ElectronicAddressType] = None
    address: Optional[StrictStr] = Field(default=None, description="Address value.")
    __properties: ClassVar[List[str]] = ["id", "unitId", "unitType", "type", "address"]
