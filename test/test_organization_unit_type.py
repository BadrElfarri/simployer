...
class TestOrganizationUnitType(unittest.TestCase):
    """OrganizationUnitType unit test stubs"""
    ...
    def testOrganizationUnitType(self):
        """Test OrganizationUnitType"""
        # inst = OrganizationUnitType()
