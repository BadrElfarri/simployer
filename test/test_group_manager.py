...
class TestGroupManager(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GroupManager:
        """Test GroupManager
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupManager`
        """
        model = GroupManager()
        if include_optional:
            return GroupManager(
