...
class TestAssignmentUnitType(unittest.TestCase):
    """AssignmentUnitType unit test stubs"""
    ...
    def testAssignmentUnitType(self):
        """Test AssignmentUnitType"""
        # inst = AssignmentUnitType()
