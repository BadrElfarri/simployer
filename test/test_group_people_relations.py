...
class TestGroupPeopleRelations(unittest.TestCase):
    """GroupPeopleRelations unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupPeopleRelations:
        """Test GroupPeopleRelations
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupPeopleRelations`
        """
        model = GroupPeopleRelations()
        if include_optional:
            return GroupPeopleRelations(
                id = '',
                people = [
                    ''
                    ],
    ...
    def testGroupPeopleRelations(self):
        """Test GroupPeopleRelations"""
