...
class TestPersonManagerRelationship(unittest.TestCase):
    """PersonManagerRelationship unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PersonManagerRelationship:
        """Test PersonManagerRelationship
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PersonManagerRelationship`
        """
        model = PersonManagerRelationship()
        if include_optional:
            return PersonManagerRelationship(
                person_name = '',
                person_id = '',
                manager_name = '',
                manager_id = '',
                is_specified_manager = True,
    ...
    def testPersonManagerRelationship(self):
        """Test PersonManagerRelationship"""
