...
class TestPersonIdentityIdentifierType(unittest.TestCase):
    """PersonIdentityIdentifierType unit test stubs"""
    ...
    def testPersonIdentityIdentifierType(self):
        """Test PersonIdentityIdentifierType"""
        # inst = PersonIdentityIdentifierType()
