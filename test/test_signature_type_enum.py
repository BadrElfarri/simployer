...
class TestSignatureTypeEnum(unittest.TestCase):
    """SignatureTypeEnum unit test stubs"""
    ...
    def testSignatureTypeEnum(self):
        """Test SignatureTypeEnum"""
        # inst = SignatureTypeEnum()
