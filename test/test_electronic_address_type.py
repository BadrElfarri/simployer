...
class TestElectronicAddressType(unittest.TestCase):
    """ElectronicAddressType unit test stubs"""
    ...
    def testElectronicAddressType(self):
        """Test ElectronicAddressType"""
        # inst = ElectronicAddressType()
