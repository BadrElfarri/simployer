...
class TestIdentityIdentifier(unittest.TestCase):
    """IdentityIdentifier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IdentityIdentifier:
        """Test IdentityIdentifier
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IdentityIdentifier`
        """
    ...
    def testIdentityIdentifier(self):
        """Test IdentityIdentifier"""
