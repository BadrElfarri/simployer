...
class TestExtendedPropertyPagination(unittest.TestCase):
    """ExtendedPropertyPagination unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtendedPropertyPagination:
        """Test ExtendedPropertyPagination
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtendedPropertyPagination`
        """
        model = ExtendedPropertyPagination()
        if include_optional:
            return ExtendedPropertyPagination(
                records = [
                    simployer_client.models.extended_property.ExtendedProperty(
                        person_id = '', 
                        property_type_id = '', 
                        property_value_id = '', 
                        property_type = '', 
    ...
    def testExtendedPropertyPagination(self):
        """Test ExtendedPropertyPagination"""
